...
public class Doctor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Doctor.this);
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Doctor.this);
        ...
        final MultiChoicesCircleButton.Item item4 = new MultiChoicesCircleButton.Item("Guide Student", getResources().getDrawable(R.drawable.brain), 30
        );
    ...
    void loadStudent(String number){
        ...
        String url= "http://app-1521348299.000webhostapp.com/hackathon/getDoctor.php?phone="+number;
        pd.show();
                        ...
                        try {
                            ...
                            //String Message = responseJSON.getString("message");
                                    ...
                                    for (int i = 0; i < jsonarray.length(); i++) {
                                        ...
                                        String regnumber = jsonobject.getString("did");
