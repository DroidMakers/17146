...
public class Pshycometric extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pshycometric);
final String area=getIntent().getExtras().getString("reg");
        listView = (ListView) findViewById(R.id.listView);
        b=(Button)findViewById(R.id.button2);
        pd = new ProgressDialog(Pshycometric.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(Pshycometric.this,Question.class);
                in.putExtra("area",s);
                startActivity(in);
    ...
    void calcresult(String number){
        ...
        String url= "http://app-1521348299.000webhostapp.com/hackathon/success.php?submit=yes&reg="+number;
        pd.show();
