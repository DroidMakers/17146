...
public class Student_Prof extends AppCompatActivity {
    ...
    TextView name,email,reg,cid,coll,perf;
    Button b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__prof2);
        ...
        perf=(TextView)findViewById(R.id.perf);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                in.putExtra("social",perf.getText().toString());
                in.putExtra("reg",getIntent().getExtras().getString("reg"));
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0; i < jsonarray.length(); i++) {
                                ...
                                String socal = jsonobject.getString("perflevel");
                                name.setText(nam);
                                email.setText(emai);
